/**
 * Arquivo: front-end/components/ui/chart.tsx
 * Area: Front-end React (componentes)
 * Funcao: Arquivo de suporte do projeto.
 * Onde fica: /front-end/components/ui/chart.tsx
 */
'use client'
...
const RechartsResponsiveContainer = dynamic(
  () => import('./chart-recharts').then((m) => m.ResponsiveContainer),
  { ssr: false, loading: () => <div className="w-full h-full" /> },
) as unknown as React.ComponentType<RechartsResponsiveContainerProps>
